...
## Phase 7: Fix broken links in cortex/IMPLEMENTATION_PLAN.md

- [ ] **7.1** BATCH: Fix missing docs/ directory references in cortex/IMPLEMENTATION_PLAN.md
  - **Scope:** Lines 82-87, 108-110, 116-118, 134-136, 142-143
  - **Context:** cortex/ has no docs/ subdirectory; links reference non-existent local files
  - **Fix Strategy:** Update all broken links to point to brain_upstream/ or root docs/ locations
    - Lines 82-87: Template references (10 links)
      - `[AGENTS.md](docs/AGENTS.md)` → `[AGENTS.md](../brain_upstream/templates/website/AGENTS.project.md)`
      - `[NEURONS.md](NEURONS.md)` → `[NEURONS.md](../NEURONS.md)` (file exists at root)
      - `[NEURONS.md](docs/NEURONS.md)` → `[NEURONS.md](../brain_upstream/templates/website/NEURONS.project.md)`
      - `[THOUGHTS.md](docs/THOUGHTS.md)` → `[THOUGHTS.md](../brain_upstream/templates/website/THOUGHTS.project.md)`
      - `[VALIDATION_CRITERIA.md](VALIDATION_CRITERIA.md)` → `[VALIDATION_CRITERIA.md](../workers/ralph/VALIDATION_CRITERIA.md)`
      - `[VALIDATION_CRITERIA.md](docs/VALIDATION_CRITERIA.md)` → `[VALIDATION_CRITERIA.md](../brain_upstream/templates/website/VALIDATION_CRITERIA.project.md)`
      - `[sitemap.md](sitemap.md)` → `[sitemap.md](../brain_upstream/templates/website/docs/sitemap.md)`
      - `[sitemap.md](docs/sitemap.md)` → `[sitemap.md](../brain_upstream/templates/website/docs/sitemap.md)`
      - `[sections.md](sections.md)` → `[sections.md](../brain_upstream/templates/website/docs/sections.md)`
      - `[sections.md](docs/sections.md)` → `[sections.md](../brain_upstream/templates/website/docs/sections.md)`
    - Lines 108-110: Skill references (5 links)
      - `[code-hygiene.md](../code-hygiene.md)` → `[code-hygiene.md](../brain_upstream/skills/domains/code-quality/code-hygiene.md)`
      - `[code-hygiene.md](../../skills/domains/code-quality/code-hygiene.md)` → `[code-hygiene.md](../brain_upstream/skills/domains/code-quality/code-hygiene.md)`
      - `[ralph-patterns.md](../ralph-patterns.md)` → `[ralph-patterns.md](../brain_upstream/skills/domains/ralph/ralph-patterns.md)`
      - `[ralph-patterns.md](../../skills/domains/ralph/ralph-patterns.md)` → `[ralph-patterns.md](../brain_upstream/skills/domains/ralph/ralph-patterns.md)`
      - `[text](target.md)` → Remove placeholder link entirely (line 110)
    - Lines 116-118: Additional skill references (3 links)
      - `[Token Efficiency](../code-quality/token-efficiency.md)` → `[Token Efficiency](../brain_upstream/skills/domains/code-quality/token-efficiency.md)`
      - `[error-handling-patterns.md](./error-handling-patterns.md)` → `[error-handling-patterns.md](../brain_upstream/skills/domains/backend/error-handling-patterns.md)`
      - `[testing-patterns.md](../../code-quality/testing-patterns.md)` → `[testing-patterns.md](../brain_upstream/skills/domains/code-quality/testing-patterns.md)`
    - Lines 134-136: Documentation references (3 links)
      - `[docs/BOOTSTRAPPING.md](../../docs/BOOTSTRAPPING.md)` → `[docs/BOOTSTRAPPING.md](../brain_upstream/docs/BOOTSTRAPPING.md)`
      - `[skills/domains/ralph/ralph-patterns.md](../../skills/domains/ralph/ralph-patterns.md)` → `[skills/domains/ralph/ralph-patterns.md](../brain_upstream/skills/domains/ralph/ralph-patterns.md)`
      - `[skills/domains/ralph/change-propagation.md](../../skills/domains/ralph/change-propagation.md)` → `[skills/domains/ralph/change-propagation.md](../brain_upstream/skills/domains/ralph/change-propagation.md)`
    - Lines 142-143: Template references (2 links)
      - `[Testing Patterns](../domains/code-quality/testing-patterns.md)` → `[Testing Patterns](../brain_upstream/skills/domains/code-quality/testing-patterns.md)`
      - `[Project Template Structure](../../templates/README.md)` → `[Project Template Structure](../brain_upstream/templates/README.md)`
  - **Steps:**
    1. Open cortex/IMPLEMENTATION_PLAN.md
    2. Fix all 23 broken links using find_and_replace_code (batch by section)
    3. Validate: `bash tools/validate_links.sh cortex/IMPLEMENTATION_PLAN.md`
  - **AC:** `bash tools/validate_links.sh cortex/IMPLEMENTATION_PLAN.md` passes with no broken link errors
  - **Estimated Time:** [L] 10-15 minutes (1 file, 23 links, multiple sections)
