      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="text-center md:text-left">
            <p className="font-serif text-xl tracking-tight" aria-label="Deene Social">DEENE</p>
            <p className="text-spaced text-[10px] opacity-70" aria-hidden="true">S O C I A L</p>
          </div>
