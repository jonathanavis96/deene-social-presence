...
- [x] **6.5** BATCH: Fix .verify/plan_snapshot.md broken links
  ...
  - **Note:** File auto-generated by loop.sh as copy of IMPLEMENTATION_PLAN.md - no action needed

- [x] **6.6** BATCH: Fix skills/playbooks/investigate-test-failures.md broken links
...
- [x] **6.7** BATCH: Fix skills/playbooks/bootstrap-new-project.md broken links
