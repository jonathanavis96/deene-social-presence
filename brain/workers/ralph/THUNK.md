...
| 288 | 2026-02-06 17:08 | 1.4 | Created website/public/404.html with GitHub Pages SPA redirect script - captures path, stores in sessionStorage, redirects to base path for client-side routing | Low |
